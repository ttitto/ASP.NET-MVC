...
namespace TtitterMvc.Extensions
{
    /*                                                                      *
    ...
    public static class NotificationExtensions
    {
        ...
        public static void AddValidationErrorNotification(this ControllerBase controller, ValidationErrors verror, String notificationType)
        {
            StringBuilder sb = new StringBuilder();
            foreach (var item in verror.Errors)
            {
                sb.AppendLine(item.PropertyExceptionMessage);
            }

            AddNotification(controller, sb.ToString(), notificationType);
        }
